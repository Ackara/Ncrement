...
FunctionsToExport = 'Coalesce', 'Convert-NcrementVersionNumberToString', 
               'Get-NcrementManifest', 'New-NcrementManifest', 
               'Save-NcrementManifest', 'Step-NcrementVersionNumber', 
               'Step-NcrementVersionNumberUsingDate', 'Update-NcrementProjectFile', 
               'Write-LineBreak'
