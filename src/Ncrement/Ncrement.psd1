...
#
# Generated by: Ackara & Contributors
#
...
NestedModules = @('Private\Assert-GitIsInstalled.ps1', 
               ...
               'Private\Update-NetcorePoject.ps1', 
               'Private\Update-NetFrameworkProject.ps1', 
               'Private\Update-VSIXProject.ps1', 
               'Public\Coalesce.ps1', 
               ...
               'Public\Update-AllProjectManifests.ps1', 
               'Public\Write-LineBreak.ps1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Coalesce', 'Get-NcrementManifest', 'New-NcrementManifest', 
               'Save-NcrementManifest', 'Step-NcrementVersionNumber', 
               'Write-LineBreak'

# Cmdlets to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no cmdlets to export.
CmdletsToExport = 'Update-AllProjectManifests'
