...
AliasesToExport = 'fimo', 'inmo', 'pumo', 'upmo'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        IconUri = 'https://raw.githubusercontent.com/Ackara/Buildbox/master/assets/icon.png'

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/Ackara/Buildbox/blob/master/releaseNotes.txt'
